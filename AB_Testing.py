...
# Merge control and test group data using concat method
...
# conclusion
"""There is no statistically significant difference between the purchasing averages for the 
    Control and Test groups, with a 95% confidence interval."""